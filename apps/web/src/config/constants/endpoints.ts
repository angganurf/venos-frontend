...
export const INFO_CLIENT = 'http://68.183.33.38:800/subgraphs/name/shadowswap/exchange'

export const INFO_CLIENT_ETH = 'https://api.thegraph.com/subgraphs/name/pancakeswap/exhange-eth'
export const BLOCKS_CLIENT = 'http://68.183.134.127:8000/subgraphs/name/shadowswap/blocks'
...
export const FARM_API = 'http://68.183.67.138:8000/subgraphs/name/shadowswap/masterchef-v2'
